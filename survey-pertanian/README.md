# Survey Pertanian - Aplikasi Survey Pertanian

Aplikasi mobile untuk pengumpulan data lahan dan hasil panen petani. Dibangun dengan React Native & Expo, menggunakan boilerplate yang dioptimalkan untuk AI code generation.

## 🌾 Fitur Aplikasi

- ✅ **Autentikasi Lengkap** - Login dan registrasi dengan penyimpanan aman (SecureStore)
- ✅ **Form Survey Pertanian** - Pengumpulan data lengkap petani, lahan, dan tanaman
- ✅ **Riwayat Survey** - Lihat semua survey yang telah dibuat
- ✅ **Dashboard Statistik** - Tampilan ringkasan total survey, lahan, dan petani
- ✅ **Penyimpanan Lokal** - Data tersimpan secara offline menggunakan AsyncStorage
- ✅ **Dark/Light Mode** - Mendukung tema gelap dan terang
- ✅ **TypeScript** - Full type safety untuk kode yang lebih aman
...
- Penyimpanan token aman dengan SecureStore

### Form Survey
Form survey mencakup:
- **Data Petani**: Nama, nomor telepon
- **Data Lahan**: Nama lahan, luas (hektar), jenis tanah, jenis irigasi
- **Data Tanaman**: Jenis tanaman, varietas, tanggal tanam, perkiraan hasil panen
- **Catatan Tambahan**: Catatan opsional untuk informasi tambahan

### Jenis Data yang Didukung
- **Jenis Tanah**: Liat, Lempung, Pasir, Gambut, Aluvial, Vulkanik, Laterit
- **Jenis Irigasi**: Tadah Hujan, Irigasi Teknis, Semi Teknis, Sederhana, Pompa Air, Sumur
- **Jenis Tanaman**: Padi, Jagung, Kedelai, Kacang Tanah, Ubi Kayu, Ubi Jalar, Cabai, Tomat, Bawang Merah, Bawang Putih, Kentang, dan lainnya
- **Satuan Hasil Panen**: Kilogram (kg), Ton, Kuintal
