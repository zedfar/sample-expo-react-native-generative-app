...
Aplikasi berita lokal untuk menampilkan berita terkini dari berbagai kategori seperti Politik, Ekonomi, Olahraga, Teknologi, Kesehatan, Hiburan, Pendidikan, dan Kriminal.
...
- 📰 **Daftar Berita** - Menampilkan berita dari berbagai kategori
- 🔥 **Breaking News** - Berita terkini yang ditampilkan secara khusus
- 🏷️ **Filter Kategori** - Filter berita berdasarkan kategori (Politik, Ekonomi, Olahraga, dll)
- 📖 **Detail Berita** - Baca berita lengkap dengan gambar dan informasi detail
- 👁️ **View Counter** - Tracking jumlah pembaca
- 📍 **Lokasi Berita** - Informasi lokasi dari berita
- 🔄 **Pull to Refresh** - Refresh untuk memuat berita terbaru
- ♾️ **Infinite Scroll** - Load more untuk memuat berita lainnya
...
- ✅ **Custom Hooks** - useNews, useBreakingNews, useNewsDetail, useSearchNews
- ✅ **Mock Data** - Data berita untuk development
